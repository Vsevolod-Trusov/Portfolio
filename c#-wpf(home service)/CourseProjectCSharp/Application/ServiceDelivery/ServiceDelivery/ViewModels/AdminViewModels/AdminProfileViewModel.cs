...
namespace ServiceDelivery.ViewModels.AdminViewModels
{
    ...
    {
        private AdminProfileModel _profilePageModel;

        public AdminProfileViewModel()
        {
            _profilePageModel = new AdminProfileModel();
        ...
        private void SelectImage()
        {
            ...
            {
                (MainFrameNavigator.GetPage("adminProfile") as AdminProfileView).ImageTitle.MinHeight = 0;
                (MainFrameNavigator.GetPage("adminProfile") as AdminProfileView).ImageTitle.MinWidth = 0;
                (MainFrameNavigator.GetPage("adminProfile") as AdminProfileView).ImageTitle.Height = 0;
                (MainFrameNavigator.GetPage("adminProfile") as AdminProfileView).ImageTitle.Width = 0;
        ...
        private void SaveImage()
        {
            ...
            ImagePath = "";
            (MainFrameNavigator.GetPage("adminProfile") as AdminProfileView).ImageTitle.MinHeight = 180;
            (MainFrameNavigator.GetPage("adminProfile") as AdminProfileView).ImageTitle.MinWidth = 360;
            (MainFrameNavigator.GetPage("adminProfile") as AdminProfileView).ImageTitle.Height = 180;
            (MainFrameNavigator.GetPage("adminProfile") as AdminProfileView).ImageTitle.Width = 360;
